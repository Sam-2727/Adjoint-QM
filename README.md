...
Right now, the repository mainly contains basic bosonic tests. The harmonic/anharmonic 1d and 6d models have been checked against traditional numerical methods. The adjoint sector of SU(N)-invariant QM with gX^4 potential has been checked for N=2,3,4 and g=1,10.